...
def run_self_check(report_path=None):
    ...
    checks = []
    required_modules = [
        "bactmdrprofiler.config",
        "bactmdrprofiler.pipeline",
        "bactmdrprofiler.io.loader",
    ]
    ...
    anti_salami = {
        "novelty_axis": "Antibiotic-class ontology + NA-aware MDR uncertainty + hypergraph pattern/posterior/compression",
        "scope_boundary": "Not a general association engine for all layers; not a phylogenetic comparative framework",
        "methodological_uniqueness": "MDR prevalence/probabilities, class-level uncertainty, hypergraph patterns and causal/co-resistance summaries",
        "primary_user_story": "MDR/XDR/PDR classification under missingness with hypergraph pattern analysis",
