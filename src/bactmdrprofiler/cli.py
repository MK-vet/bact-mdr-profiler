...
def _build_parser():
    p = argparse.ArgumentParser(prog='bact-mdr-profiler', description='Run bact-mdr-profiler pipeline')
...
def main(argv=None):
    ...
    try:
        ...
        outdir = Path(getattr(cfg, 'output_dir', 'mdr_results'))
