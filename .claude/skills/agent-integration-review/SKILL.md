...
You are an **integration reviewer** for the bact-* tool suite. Verify bact-mdr-profiler consistency.
...
2. **Data format**: CSV 0/1/NA binary, Int8; ontology YAML for drug-to-class
