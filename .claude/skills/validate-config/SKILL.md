...
Validate config against bact-mdr-profiler schema. Use `$ARGUMENTS` or `examples/config.yaml`.
...
Report: parsed OK, schema version, ontology configured, any warnings.
